{
  ...
  spec: {
    ...
    endpoints: {
      ...
      '#relabelings':: d.obj(help='"RelabelConfigs to apply to samples before scraping. Prometheus Operator automatically adds relabelings for a few standard Kubernetes fields and replaces original scrape job name with __tmp_prometheus_job_name. More info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config"'),
      relabelings: {
        '#withAction':: d.fn(help="\"Action to perform based on regex matching. Default is 'replace'\"", args=[d.arg(name='action', type=d.T.string)]),
        withAction(action): { action: action },
        '#withModulus':: d.fn(help='"Modulus to take of the hash of the source label values."', args=[d.arg(name='modulus', type=d.T.integer)]),
      ...
      '#withRelabelings':: d.fn(help='"RelabelConfigs to apply to samples before scraping. Prometheus Operator automatically adds relabelings for a few standard Kubernetes fields and replaces original scrape job name with __tmp_prometheus_job_name. More info: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config"', args=[d.arg(name='relabelings', type=d.T.array)]),
    ...
    '#withTargetLabels':: d.fn(help='"TargetLabels transfers labels on the Kubernetes Service onto the target."', args=[d.arg(name='targetLabels', type=d.T.array)]),
    withTargetLabels(targetLabels): { spec+: { targetLabels: if std.isArray(v=targetLabels) then targetLabels else [targetLabels] } },
    '#withTargetLabelsMixin':: d.fn(help='"TargetLabels transfers labels on the Kubernetes Service onto the target."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetLabels', type=d.T.array)]),
