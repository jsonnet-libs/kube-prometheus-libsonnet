{
  ...
  spec: {
    ...
    containers: {
      ...
      env: {
        ...
        valueFrom: {
          ...
          '#fieldRef':: d.obj(help='"Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs."'),
          fieldRef: {
    ...
    '#prometheusRulesExcludedFromEnforce':: d.obj(help='"PrometheusRulesExcludedFromEnforce - list of prometheus rules to be excluded from enforcing of adding namespace labels. Works only if enforcedNamespaceLabel set to true. Make sure both ruleNamespace and ruleName are set for each pair"'),
    ...
    '#remoteRead':: d.obj(help='"If specified, the remote_read spec. This is an experimental feature, it may change in any upcoming release in a breaking way."'),
    remoteRead: {
      ...
      withBearerTokenFile(bearerTokenFile): { bearerTokenFile: bearerTokenFile },
      '#withName':: d.fn(help='"The name of the remote read queue, must be unique if specified. The name is used in metrics and logging in order to differentiate read configurations.  Only valid in Prometheus versions 2.15.0 and newer."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    ...
    '#remoteWrite':: d.obj(help='"If specified, the remote_write spec. This is an experimental feature, it may change in any upcoming release in a breaking way."'),
    remoteWrite: {
      '#basicAuth':: d.obj(help='"BasicAuth for the URL."'),
      basicAuth: {
        '#password':: d.obj(help='"The secret in the service monitor namespace that contains the password for authentication."'),
      ...
      metadataConfig: {
        '#withSend':: d.fn(help='"Whether metric metadata is sent to remote storage or not."', args=[d.arg(name='send', type=d.T.boolean)]),
        withSend(send): { metadataConfig+: { send: send } },
        '#withSendInterval':: d.fn(help='"How frequently metric metadata is sent to remote storage."', args=[d.arg(name='sendInterval', type=d.T.string)]),
      ...
      '#withName':: d.fn(help='"The name of the remote write queue, must be unique if specified. The name is used in metrics and logging in order to differentiate queues. Only valid in Prometheus versions 2.15.0 and newer."', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
      '#withProxyUrl':: d.fn(help='"Optional ProxyURL"', args=[d.arg(name='proxyUrl', type=d.T.string)]),
      withProxyUrl(proxyUrl): { proxyUrl: proxyUrl },
    ...
    '#withEnforcedTargetLimit':: d.fn(help='"EnforcedTargetLimit defines a global limit on the number of scraped targets. This overrides any TargetLimit set per ServiceMonitor or/and PodMonitor. It is meant to be used by admins to enforce the TargetLimit to keep overall number of targets under the desired limit. Note that if TargetLimit is higher that value will be taken instead."', args=[d.arg(name='enforcedTargetLimit', type=d.T.integer)]),
    ...
    '#withScrapeInterval':: d.fn(help='"Interval between consecutive scrapes."', args=[d.arg(name='scrapeInterval', type=d.T.string)]),
