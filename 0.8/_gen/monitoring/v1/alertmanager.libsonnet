{
  ...
  spec: {
    ...
    '#withConfigSecret':: d.fn(help="\"ConfigSecret is the name of a Kubernetes Secret in the same namespace as the Alertmanager object, which contains configuration for this Alertmanager instance. Defaults to 'alertmanager-\u003calertmanager-name\u003e' The secret is mounted into /etc/alertmanager/config.\"", args=[d.arg(name='configSecret', type=d.T.string)]),
